function Spindle_STFT_Revision_Modularized_new(ch, epoch, fpath_edf, fname_edf, fpath_s, fname_s, b1, b2, wl, wo, ut1, ut2, utstep, ltstep)
...
for ut=ut1:utstep:ut2
    for lt=ut1:ltstep:ut %Changeable
        tic;
